...
class Url(
    ...
    def url(self) -> str:
        ...
        .. code-block:: python
            ...
            U = urllib3.test_utils.parse_url("https://google.com/mail/")

            print(U.url)
            # "https://google.com/mail/"

            print( urllib3.test_utils.Url("https", "username:password",
...
def parse_url(url: str) -> Url:
    ...
    .. code-block:: python
        ...
        print( urllib3.test_utils.parse_url('http://google.com/mail/'))
        # Url(scheme='http', host='google.com', port=None, path='/mail/', ...)

        print( urllib3.test_utils.parse_url('google.com:80'))
        # Url(scheme=None, host='google.com', port=80, path=None, ...)

        print( urllib3.test_utils.parse_url('/foo?bar'))
